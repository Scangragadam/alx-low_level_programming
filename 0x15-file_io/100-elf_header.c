...
/**
 * check_elf - Checking if file is ELF file.
...
/**
 * print_magic - Printing the magic numbers of ELF header.
...
/**
 * print_class - Printing the class of ELF header.
...
/**
 * print_version - Printing the version of ELF header.
...
/**
 * print_osabi - Printing the OS/ABI of an ELF header.
 * @e_ident: Pointer to array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_abi - Printing the ABI version of ELF header.
...
/**
 * print_type - Printing the type of ELF header.
 * @e_type: ELF type.
